    ...
    return (
        <div class="bg-gray-100 h-screen justify-center pt-36">
            <div class="flex flex-col items-center">
                ...
                <div class="font-bold text-2xl xl:text-7xl lg:text-6xl md:text-5xl mt-10 text-cyan-600">
                    <a href="/">
                    {'<- Back to HomePage'}
                    </a>
                </div>
